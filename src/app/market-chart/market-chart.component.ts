...
export class MarketChartComponent implements OnChanges {
 ...
 TotalClosed = 300000;
  ...
  updateChart() {
    ...
    this.TotalCases = this.marketStatus[0].corona_world;
    this.TotalDeaths = this.marketStatus[0].corona_world_deaths;
    this.TotalClosed = this.marketStatus[0].corona_world_recovered;
  ...
  buildChart() {
    ...
    var valueline2 = d3.line<MarketPrice>()
     ...
     .y(function (d) { console.log('Open market'); console.log(d.corona_world); return _this.chartProps.y(d.open); });
